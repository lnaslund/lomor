...
k_data<-read.csv("../1-data/2-k-estimation/k_TN_meta_analysis_data.csv") %>% 
  ...
  # remove below observations b/c yields unrealistic N concentrations*
...
write.csv(t,"../3-output/summary_tn_model_selection.csv", row.names = FALSE)
...
write.csv(t,"../3-output/summary_no3_model_selection.csv", row.names = FALSE)
